// Standard transaction categories - Client version without server directive
...
/**
 * Normalizes a category string to a standard category (client-side version)
 * @param categoryInput User input that might refer to a category
 * @returns Standardized category name or null if no match
 */
export function normalizeCategory(categoryInput: string): string | null {
