    ...
    if (sortConfig.key) {
      itemsToProcess.sort((a, b) => {
        ...
        if (sortConfig.key === 'date') {
          return sortConfig.direction === 'ascending' ? new Date(valA as string).getTime() - new Date(valB as string).getTime() : new Date(valB as string).getTime() - new Date(valA as string).getTime();
        }
