...
export default function BudgetsPage() {
  ...
  const [subscriptionResults, setSubscriptionResults] = useState<DetectedSubscription[] | null>(null);
  ...
  const handleDetectSubscriptions = async () => {
    ...
    try {
        ...
        if (detected.length === 0) {
            ...
            toast({ title: "Subscriptions Detected", description: `Found ${detected.length} potential subscription(s).`, variant: "default" });
        }
    } catch (error: any) {
