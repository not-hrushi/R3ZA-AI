              ...
              if (transactionsMatch) {
                ...
                if (transactionMatches.length > 0) {
                  ...
                  if (completeTransactions.length > 0) {
                    ...
                    return processPartialData(partialData);
                  }
                }
              }
            } else {
...
function processPartialData(partialData: any) {
  ...
  if (processedTransactions.length > 0) {
    return {
      ...
      parsingNotes: `Successfully processed ${processedTransactions.length} transactions. Some transactions may have been filtered out due to incomplete data.`
    };
  }
